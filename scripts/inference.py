...
def main(args):
    ...
    for i , batch in enumerate(data_loader):
        ...
        with torch.no_grad():
            ...
            # calculate the distortion map
            #imgs, _ = net.decoder([latent_codes_[0].unsqueeze(0).cuda()],conditions_, input_is_latent=True, randomize_noise=False, return_latents=True)
            imgs = result_image
            ...
            result_image, latent_codes = net.decoder([latent_codes_],conditions, input_is_latent=True, randomize_noise=False, return_latents=True)
