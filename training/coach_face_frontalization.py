...
from models.psp_face_frontalization import pSp
...
class Coach:
    def __init__(self, opts):
        ...
        self.net, _ = setup_model(opts.checkpoint_path, self.device , train=True)
        ...
        if self.opts.id_lambda > 0:
            if 'ffhq' in self.opts.dataset_type or 'celeb' or 'ffhq_frontalization' in self.opts.dataset_type:
    ...
    def calc_loss(self, x, y, y_hat, latent, res_delta):
        ...
        if self.opts.l2_lambda > 0:
            loss_l2 = F.mse_loss(y_hat, y) #mse_loss
