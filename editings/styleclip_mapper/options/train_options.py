...
class TrainOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--image_dir' , type=str , default=None , help='Image directory to load images for HFGI')
        ...
        self.parser.add_argument('--latents_train_path', type=str, required=False, help="The latents for the training")
        self.parser.add_argument('--latents_test_path', type=str, required=False, help="The latents for the validation")
        ...
        self.parser.add_argument('--ckpt', default="/path/to/weights", type=str, help='Path to HFGI ckpt model weights')
        self.parser.add_argument('--truncation_psi', default=0.7, type=int)
        self.parser.add_argument('--stylegan_size', default=1024, type=int)
        self.parser.add_argument('--ir_se50_weights', default='/content/drive/MyDrive/HFGI_New/HFGI/pretrained/model_ir_se50.pth', type=str, help="Path to facial recognition network used in ID loss")
