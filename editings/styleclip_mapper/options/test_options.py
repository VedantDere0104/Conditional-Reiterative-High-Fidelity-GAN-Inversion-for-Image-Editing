...
class TestOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--ckpt', default="/content/drive/MyDrive/HFGI_New/HFGI/experiment/ffhq_condition_first/checkpoints/iteration_16000.pt", type=str, help='Path to HFGI ckpt model weights')
        ...
        self.parser.add_argument('--latents_test_path', default='/content/drive/MyDrive/test_faces.pt', type=str, help="The latents for the validation")
        ...
        self.parser.add_argument('--n_images', type=int, default=10, help='Number of images to output. If None, run on all data')
